...
@NamedQueries({
    ...
    @NamedQuery(name = "Tareas.findbyEstadoAndUserId", query = "SELECT t FROM Tareas t WHERE t.estado = :estado AND t.usuario.idUsuario = :idUsuario"),
...
public class Tareas implements Serializable {
    ...
    public String toString() {
        return "com.tareas.entidades2.Tareas[ idTarea=" + idTarea + " ]";
    }
